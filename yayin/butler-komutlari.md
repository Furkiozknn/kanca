...
butler push build\web furkiozknn/kanca:html5 --userversion 0.2.0

# Windows masaüstü
butler push build\windows furkiozknn/kanca:windows --userversion 0.2.0
```
...
Depo yerelde `v0.2` etiketiyle işaretli:
